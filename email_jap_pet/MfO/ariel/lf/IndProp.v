...
Proof.
  ...
  - intros. induction H.
    ...
    + destruct IHeven'1. simpl. apply IHeven'2.
      * simpl. apply ev_SS. apply (ev_sum n m). 
        (*Aplica o even passando as 2 variáveis*)
        -- apply IHeven'1.
        -- apply IHeven'2.
...
Theorem leb_complete : forall n m,
  n <=? m = true -> n <= m.
Proof.
  intros n m Hip. generalize dependent n. induction m.
  - intros. induction n.
    + auto.
    + discriminate Hip.
  - intros. induction n.
    + apply O_le_n.
    + apply n_le_m__Sn_le_Sm. apply IHm. simpl in Hip. apply Hip.
Qed.
...
Proof.
  intros. apply leb_correct. apply (le_trans n m o). apply leb_complete in H. apply H.
...
Inductive subseq : list nat -> list nat -> Prop :=
  | c1 l : subseq [] l
  | c2: forall h l1 l2, subseq l1 l2 -> subseq l1 (h::l2)
  | c3: forall h l1 l2, subseq l1 l2 -> subseq (h::l1) (h::l2).
...
Theorem subseq_trans : forall (l1 l2 l3 : list nat),
  ...
  subseq l1 l3.
Proof.
  intros. generalize dependent l3. induction l1 as [| h t].
  - intros. apply c1.
  - intros. induction l2. 
    + inversion H0. rewrite H1.  apply H. 
    + apply c2. apply IHl3. 
      * intros. 
