...
Definition inv_bit (b : bit) : bit :=
  match b with
  | B0 => B1
  | B1 => B0
  end.

Example test_inv_bit1:    inv_bit B0 = B1.
Proof. simpl. reflexivity.  Qed.
Example test_inv_bit2:    inv_bit B1 = B0.
Proof. simpl. reflexivity.  Qed.

Definition inv_nybble (nb : nybble) : nybble := 
  match nb with
  | (bits a b c d) => bits (inv_bit a)  (inv_bit b)  (inv_bit c)  (inv_bit d)
  end.

Example test_inv_nybble1: inv_nybble (bits B0 B0 B0 B0) = bits B1 B1 B1 B1.
Proof. simpl. reflexivity. Qed.
...
Proof.
  ...
  - rewrite -> x. simpl. rewrite -> x. reflexivity.
