...
Proof.
  intro p. destruct p. simpl. reflexivity. Qed.
(** [] *)
...
Proof.
  intros l1 l2 P. induction l2 as [| n' l' hip].
  - simpl. rewrite <- rev_involutive. rewrite <- P. rewrite rev_involutive. reflexivity.
  - rewrite <- rev_involutive. rewrite <- P. rewrite rev_involutive. reflexivity.
Qed.
...
Proof.
  intros d x v. simpl. induction x. 
  - simpl. induction n.
    + simpl. reflexivity.
    + simpl. 
Admitted.
