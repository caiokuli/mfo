...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros. injection H as H1. injection H0 as Hp. rewrite Hp. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  - intros. destruct m.
    + discriminate.
    + apply f_equal. apply IHn. rewrite <- plus_n_Sm in H. rewrite <- plus_n_Sm in H. 
      injection H as Hip. apply Hip.
Qed.

(*  rewrite <- E. intro. rewrite <- E in H.   Abort. *)
(** [] *)
...
Proof.
  ...
  - intros. destruct l.
    + discriminate.
    + simpl. simpl in H. injection H as Hip. apply IHn. apply Hip.
Qed.
(** [] *)
...
Proof.
  ...
  - intros. injection H. intros. rewrite <- H0.  rewrite <-  H1. auto.
  - intros l1 l2. simpl. destruct h. destruct (split l') as [l1' l2'].
    + intro Hip. injection Hip. intros. rewrite <- H. rewrite <- H0. simpl. rewrite IHl. auto. auto.
Qed.
