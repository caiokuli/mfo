...
Proof.
  intros n. induction n as [| n'] eqn:N.
  - intros. left. auto.
  - intros. right. destruct m eqn: M.
    + auto.
    + discriminate.
Qed.
...
Fact not_implies_our_not : forall (P:Prop),
  ~ P -> (forall (Q:Prop), P -> Q).
Proof.
  intros P HP Q HQ. destruct HP. apply HQ. Qed.
(** [] *)
...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros. unfold not. intro. destruct H0. apply H. apply H1. Qed.
...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof.
  intros. unfold not. intro. apply H. destruct H. apply H.
Qed.
(** [] *)
...
Theorem iff_refl_2 : forall P : Prop,
  P <-> P.
Proof.
  intros. split.
  - intro. apply H.
...
Theorem iff_trans : forall P Q R : Prop,
  (P <-> Q) -> (Q <-> R) -> (P <-> R).
Proof.
  intros.  destruct H. destruct H0. split. intros.
  - apply H0. apply H. trivial.
  - intro. apply H1. apply H2. trivial. 
Qed.
(** [] *)
...
Proof.
  intros. unfold not.
  - intro. destruct H0 as [x E]. apply E. apply H. Qed.
...
Proof.
  intros. split.
  - induction l.
    + intro. simpl. simpl in H. trivial.
    + simpl. intro. split.
      * apply H. left. auto.
  ...
  - intros. induction l.
    ...
    + destruct H0 as [| H1 H2].
      * simpl in H. destruct H. rewrite H0 in H. apply H.
      * simpl in H. apply proj2 in H. apply IHl in H. apply H. apply H1.
Qed.
...
Proof.
  ...
  - unfold combine_odd_even. destruct (oddb (S n0)).
    + apply H. auto.
    + apply H0. auto.
Qed.
...
Proof.
  intro. induction n. 
  - intro. destruct oddb eqn: E. 
    + intro. destruct H0. discriminate E.
    + intro. discriminate.
  - unfold combine_odd_even. destruct (oddb (S n)) eqn: E.
    + intros . apply H.
