...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = (minustwo o).
Proof.
  intros n m o p H1 H2. apply trans_eq with (m := m). apply H2. apply H1.
Qed.
(** [] *)
...
(** By writing [injection H] at this point, we are asking Coq to
  ...
  injection H as Hnm. apply Hnm. (* injection H as Hnm == injection H. intros Hnm *)
Qed.
...
Proof.
  intros n m o H.
  injection H as H1 H2. (* injection H as H1 H2 = injection H. intros H1 H2 *)
...
Example injection_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  x = y.
Proof.
  intros X x y z l j H1 H2. injection H2 as C D. symmetry. apply C.
Qed.
(** [] *)
...
Example discriminate_ex3 :
  forall (X : Type) (x y z : X) (l j : list X),
    ...
    x = z.
Proof.
  intros X x y z A B. intros C. discriminate C.
Qed.
(** [] *)
...
Proof.
  ...
  - intros m H1. destruct m as [| m'].
    ...
    + simpl in H1. rewrite <- plus_n_Sm in H1.
      ...
      apply IH in H2. rewrite H2. reflexivity.
Qed.
(** [] *)
...
Theorem plus_n_n_injective' : forall n m,
     ...
     n = m.
Proof.
  intros n m H1. induction n as [| n' IH].
  - destruct m as [| m'].
    + reflexivity.
    + discriminate H1.
  - destruct m as [| m'].
 ...
 Admitted.
(*aqui precisa introduzi por partes igual no outro filha da puta*)
...
Theorem eqb_true : forall n m,
    n =? m = true -> n = m.
Proof.
  intros n. destruct n as [|n'] eqn:K.
    - intros m eq. destruct m as [|m'] eqn:T.
      + reflexivity.
      + discriminate eq.
    - intros m eq. destruct m as [|m'] eqn:T.
      + discriminate eq.
      + apply f_equal. simpl in eq. Admitted.
(** [] *)
