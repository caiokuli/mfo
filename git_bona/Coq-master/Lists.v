...
Theorem surjective_pairing_stuck : forall (p : natprod),
  p = (fst p, snd p).
Proof.
  intro. simpl. (* Doesn't reduce anything! *)
Abort.
...
Compute nonzeros [2;4;5;0;8;7;0;0;0;6].
...
Definition sum' (l1 l2 : bag): bag := l1 ++ l2.
...
Definition member (v:nat) (s:bag) : bool :=
  match s with
  | [] => false
  | h::t => if count v s =? 0 then false else true
end.
...
Compute remove_one 5 [2;1;5;4;5;1;4].
...
(* FILL IN HERE *)
(* USAR O REVERSO INVOLUTIVEL (rev_injective) *)
