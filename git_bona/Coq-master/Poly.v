...
Proof.
  intros X l1 l2. induction l1.
    - simpl. SearchRewrite (_ ++ []). rewrite app_nil_r. reflexivity.
    - simpl. rewrite IHl1. SearchRewrite( (_ ++ _) ++ _). rewrite app_assoc. reflexivity.
Qed.
...
Compute combine [2;3;4] [2;3;4].
Compute combine [2;3;4] [2;3;4;7;8].
...
Definition partition {X : Type}
                     ...
                     (l : list X)
                   : list X * list X :=
  (filter test l, filter negb (.) test l).
