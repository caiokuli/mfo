...
Theorem plus_comm : forall n m : nat,
  n + m = m + n.
Proof.
  intros. induction m. induction n.
  - reflexivity.
...
Proof.
  intros.
  induction p. induction n. induction m.
  -reflexivity.
  -simpl. reflexivity.
  -simpl. rewrite IHn. reflexivity.
  -rewrite <- plus_n_Sm. rewrite <- plus_n_Sm. rewrite IHp.
...
- rewrite <- mult_n_Sm. simpl. rewrite IHn. rewrite plus_comm. reflexivity.
  Qed.
(** [] *)
...
Proof.
  ...
  simpl. induction n.
  - reflexivity.
  - rewrite <- plus_O_n. rewrite plus_comm. reflexivity.
 Qed.
