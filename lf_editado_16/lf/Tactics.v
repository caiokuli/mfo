...
Proof.
  intros.
  injection H0 as H1. symmetry. apply H1.
Qed.
(** [] *)
...
Proof.
  ...
  - (* m = S m' *) intros n eq. destruct n as [| n'] eqn:E.
    + (* n = O *) discriminate eq.
    + (* n = S n' *) apply f_equal.
      apply IHm'. injection eq. intro goal. apply goal. Qed.
...
Proof.
  ...
  - intros. rewrite <- H. simpl. apply IHl. reflexivity.
Qed. 
